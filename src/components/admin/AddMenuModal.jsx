	...
	return (
		...
		>
			<div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
				<DialogPanel className="bg-white rounded-[1.75rem] border border-black/5 p-6 max-w-sm w-full shadow-[0_24px_80px_rgba(15,23,42,0.15)] duration-200 ease-out data-closed:transform-[scale(95%)] data-closed:opacity-0">
					...
					<div className="space-y-4">
						...
						<div>
							...
							<textarea
								...
								rows="3"
								placeholder="Describe la carta aquí"
					...
					<div className="mt-6 flex gap-3">
						...
						<button
							...
							onClick={handleAdd}
							disabled={!name.trim()}
							className="flex-1 inline-flex items-center justify-center gap-2 rounded-2xl bg-gray-950 px-4 py-3 text-sm font-medium text-white transition hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
						>
