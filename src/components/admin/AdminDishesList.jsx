		...
		<div className="space-y-4">
			...
			<div className="space-y-3">
				{activeCategory.dishes?.map((dish) => (
					<div
						key={dish.id}
						className={`rounded-3xl border border-black/5 bg-white/90 p-5 transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(15,23,42,0.06)] sm:p-6 ${
							draggedId === dish.id
					...
					>
						...
						<div className="mt-5 flex items-center justify-end gap-2 border-t border-black/5 pt-4 sm:mt-4 sm:border-0 sm:pt-0">
							{dish.available === false && (
								<span className="rounded-full bg-gray-200 px-3 py-1 text-sm font-medium text-gray-400 mr-2">
									No disponible
								</span>
							)}
							<button
